package com.example.danielgomez22.omgapp;
...
/**
 * Created by danielgomez22 on 9/12/14.
 */
public class DetailActivity extends Activity {

    private static final String IMAGE_URL_BASE = "http://covers.openlibrary.org/b/id/"; // 13
    private String mImageURL; // 13
    private ShareActionProvider mShareActionProvider; // 14
